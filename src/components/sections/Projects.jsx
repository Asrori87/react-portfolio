        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 sm:p-8 border border-white/5 rounded-xl hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-2xs shadow-blue-500 transition-all">
            ...
            <p className="text-gray-400 text-sm">
              A responsive dashboard built with React, Next.js, and Tailwind
              CSS. It features a searchable table, sortable columns, and a
              customizable chart using Chart.js.
            </p>
          ...
          <div className="p-6 sm:p-8 border border-white/5 rounded-xl hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-2xs shadow-blue-500 transition-all">
            ...
            <p className="text-gray-400 text-sm">
              A responsive university library management system built with
              React, Next.js, and Tailwind CSS. It features a searchable book
              list, a book details page, and a borrowing system using the
          ...
          <div className="p-6 sm:p-8 border border-white/5 rounded-xl hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-2xs shadow-blue-500 transition-all">
            ...
            <p className="text-gray-400 text-sm">
              ...
              CSS. It features a searchable movie list, a detailed movie page,
              and a rating system using the IMDb API.
            </p>
            <div className="flex flex-wrap gap-2 mt-4">
